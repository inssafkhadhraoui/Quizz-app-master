...
public class AgilesQ3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agiles_q3);
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AgilesQ3.this,QuizActivity.class);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AgilesQ3.this,AgilesQ2.class);
                startActivity(intent);
            }
        });
        // bouton voir réponse
        ...
        btnTerminer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AgilesQ3.this,ScoreFinal.class);
                startActivity(intent);
            }
        });
    }

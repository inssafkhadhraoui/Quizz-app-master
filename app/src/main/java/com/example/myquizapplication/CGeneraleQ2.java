...
public class CGeneraleQ2 extends AppCompatActivity {
    ImageView btnhome, btnnext, btnback;
    Button btn;
    RadioButton rb1,rb2,rb3,rb4;
    TextView tvscore;
    public void afficherReponse(){
        if(Score.isM4q2()==true) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cgenerale_q2);
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CGeneraleQ2.this,QuizActivity.class);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CGeneraleQ2.this,CGeneraleQ3.class);
                startActivity(intent);
            }
        });
        // back button
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CGeneraleQ2.this,BD.class);
                startActivity(intent);
            }
        });
        // bouton voir réponse

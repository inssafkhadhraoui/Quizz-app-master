...
public class MarketingQ2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marketing_q2);
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MarketingQ2.this,QuizActivity.class);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MarketingQ2.this,MarketingQ3.class);
                startActivity(intent);
            }
        });
        // back button
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MarketingQ2.this,TIC.class);
                startActivity(intent);
            }
        });
        // bouton voir réponse

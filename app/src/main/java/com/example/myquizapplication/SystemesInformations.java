...
public class SystemesInformations extends AppCompatActivity {
   ImageView btnhome, btnnext, btnback;
    RadioButton rb1,rb2,rb3,rb4;
    TextView tvscore;
    Button btn;
     public void afficherReponse(){
        if(Score.isM1q1()==true) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_systemes_informations);
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SystemesInformations.this,QuizActivity.class);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SystemesInformations.this,AgilesQ2.class);
                startActivity(intent);
            }
        });
